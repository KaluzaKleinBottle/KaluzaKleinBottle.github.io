...
The plugin works for users that are added by the administrator, for users that register with their username/password and 
for users that register using our <a href="https://wordpress.org/plugins/oa-social-login/">Social Login</a> plugin for WordPress.
